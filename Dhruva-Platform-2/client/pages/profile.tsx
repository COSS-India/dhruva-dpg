...
export default function Profile() {
  ...
  const updateProfile = () => {
    mutation.mutate(
      { name: ipName, password: ipPassword },
      {
        onSuccess: (data) => {
          toast({
            title: "Success",
  ...
  return (
    <>
      ...
      >
        <Box
          ml={smallscreen ? "0rem" : "2rem"}
          mt={smallscreen ? "3rem" : "1rem"}
          background={"white"}
          width="90vw"
          height={smallscreen ? "45vh" : "60vh"}
          pl="1rem"
          pt="1rem"
        >
          <Center>
