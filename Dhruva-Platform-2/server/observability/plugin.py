...
class ObservabilityPlugin:
    ...
    def register_endpoints(self, app: FastAPI) -> None:
        ...
        @app.get(
            ...
            description="Returns health status and configuration of the observability plugin",
            include_in_schema=True
        )
        ...
        @app.get(
            ...
            description="Returns the current configuration of the observability plugin",
            include_in_schema=True
        )
